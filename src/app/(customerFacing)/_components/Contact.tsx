  ...
  return (
    <section className="text-center  bg-[#FFFFFF] py-15 space-y-20 px-8 md:px-0 ">
      <div className="space-y-5 flex flex-col items-center">
        <h1 className="text-lg md:text-4xl font-mono">Join the club and get the benefits</h1>
      ...
      <div>
        <input type="email" placeholder="you@gmail.com" className="p-4 bg-[#F9F9F9] md:w-1/4" />
